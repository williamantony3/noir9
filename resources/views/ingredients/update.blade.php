        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Edit Ingredients</h6>
            </div>
        ...
        <div class="col">
          <div class="card">
            <div class="card-body">
              ...
              @endif
              <form action={{ route('updateIngredients',$ing) }} method="post">
                {{ csrf_field() }}
                <div class="form-group">
                  <label for="name" class="form-control-label">Ingredient's Name</label>
                  <input class="form-control @error('name') is-invalid              
                  @enderror" type="text" id="name" name="name" required autofocus value="{{ $ing->name }}"/>
                  @error('name')
